...
static const char mut_dist[10][10] = {  {  0, 2, 2, 2, 1, 1, 2, 1, 2, 2 },   /* AA */
                                        {  2, 0, 2, 2, 1, 2, 1, 2, 1, 2 },   /* CC */
                                        {  2, 2, 0, 2, 2, 1, 1, 2, 2, 1 },   /* GG */
                                        {  2, 2, 2, 0, 2, 2, 2, 1, 1, 1 },   /* TT */
                                        {  1, 1, 2, 2, 0, 1, 1, 1, 1, 2 },   /* AC */
                                        {  1, 2, 1, 2, 1, 0, 1, 1, 2, 1 },   /* AG */
                                        {  2, 1, 1, 2, 1, 1, 0, 2, 1, 1 },   /* CG */
                                        {  1, 2, 2, 1, 1, 1, 2, 0, 1, 1 },   /* AT */
